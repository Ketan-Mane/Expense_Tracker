				...
				<div className="flex items-center justify-between">
					<Link to="/">
						<div className="flex items-center gap-3">
							<div className="max-sm:hidden w-10 h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center">
							...
							<div>
								...
								<p className="text-xs text-gray-500 max-sm:hidden">Smart Finance Management</p>
							</div>
						</div>
					</Link>
